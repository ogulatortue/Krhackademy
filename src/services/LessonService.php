...
class LessonService {
    ...
    public function findAllSorted(?int $userId = null): array {
        $sql = "SELECT l.id, l.lesson_id_str, l.title, l.category, l.description, l.difficulty, l.icon_class FROM lessons l ORDER BY CASE WHEN l.category = 'Introduction' THEN 0 ELSE 1 END, l.category ASC, CASE l.difficulty WHEN 'Débutant' THEN 1 WHEN 'Initié' THEN 2 WHEN 'Avancé' THEN 3 WHEN 'Expert' THEN 4 ELSE 5 END ASC, l.id ASC";
